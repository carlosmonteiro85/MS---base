package br.com.projeta.gestor.views.addressform;
...
@Route(value = "projeta-gestor/address-form", layout = MainLayout.class)
public class AddressFormView extends Composite<VerticalLayout> {

    public AddressFormView(AuthService authService) {
