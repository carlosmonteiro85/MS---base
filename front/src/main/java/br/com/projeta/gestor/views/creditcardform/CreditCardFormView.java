package br.com.projeta.gestor.views.creditcardform;
...
@Route(value = "projeta-gestor/credit-card-form", layout = MainLayout.class)
// @RolesAllowed("USER")
// @AnonymousAllowed
public class CreditCardFormView extends Div {
    ...
    public CreditCardFormView(AuthService authService) {
